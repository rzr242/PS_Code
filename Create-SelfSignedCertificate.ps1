...
.EXAMPLE
PS C:\> .\Create-SelfSignedCertificate.ps1 -CommonName "MyCert" -StartDate 2015-11-21 -EndDate 2027-11-21 -Password (ConvertTo-SecureString -String "pass@word1" -AsPlainText -Force)
